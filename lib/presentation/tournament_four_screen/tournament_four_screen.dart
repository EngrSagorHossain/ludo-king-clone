import '../tournament_four_screen/widgets/levelcounter_item_widget.dart';
import 'controller/tournament_four_controller.dart';
import 'models/levelcounter_item_model.dart';
          ...
          Padding(
              ...
              child: Obx(() => GridView.builder(
                  ...
                  itemCount: controller.tournamentFourModelObj.value
                      .levelcounterItemList.value.length,
                  itemBuilder: (context, index) {
                    LevelcounterItemModel model = controller
                        .tournamentFourModelObj
                        .value
                        .levelcounterItemList
                        .value[index];
                    return LevelcounterItemWidget(model);
                  }))),
