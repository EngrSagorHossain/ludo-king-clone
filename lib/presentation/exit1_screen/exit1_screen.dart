...
class Exit1Screen extends GetWidget<Exit1Controller> {
  const Exit1Screen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            body: Container(
                ...
                child: Stack(
                    ...
                    children: [_buildOneStack(), _buildExitStack()]))));
  }
