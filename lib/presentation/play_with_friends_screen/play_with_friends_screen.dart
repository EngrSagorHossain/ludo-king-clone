...
class PlayWithFriendsScreen extends GetWidget<PlayWithFriendsController> {
  const PlayWithFriendsScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the playWithFriendsTwoScreen when the action is triggered.
  onTapNext() {
    Get.toNamed(
