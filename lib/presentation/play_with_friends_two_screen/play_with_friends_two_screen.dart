...
class PlayWithFriendsTwoScreen extends GetWidget<PlayWithFriendsTwoController> {
  const PlayWithFriendsTwoScreen({Key? key}) : super(key: key);
  ...
  /// Section Widget
  Widget _buildAndroidLargeColumn1() {
    return Container(
        width: 290.h,
