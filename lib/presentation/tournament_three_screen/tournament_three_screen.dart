import '../tournament_three_screen/widgets/stack_item_widget.dart';
          ...
          Padding(
              ...
              child: Obx(() => GridView.builder(
                  ...
                  itemCount: controller
                      .tournamentThreeModelObj.value.stackItemList.value.length,
                  itemBuilder: (context, index) {
                    StackItemModel model = controller.tournamentThreeModelObj
                        .value.stackItemList.value[index];
