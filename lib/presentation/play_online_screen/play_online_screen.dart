...
class PlayOnlineScreen extends GetWidget<PlayOnlineController> {
  ...
  /// Navigates to the playOnlineTwoScreen when the action is triggered.
  onTapNext() {
    Get.toNamed(
      AppRoutes.playOnlineTwoScreen,
    );
  }
}
